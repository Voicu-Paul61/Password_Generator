...
def create_password():
    ...
    # print(capitalized_letters_in_password)
...
def ask_for_input():
    ...
    return [file_name, password_len, captalized_letters_exists, small_letters_exists, digits_exists,
            special_chrs_exists]
...
special_chrs = [chr(x) for x in range(32, 48)] + ([chr(x) for x in range(58, 65)]) + (
